        ...
        <ScreenLayout showToolbar>
            <View style={styles.container}>
                <View style={styles.innerView}>
                    ...
                    <Text bold h3 style={styles.descption}><Text bold h3 style={StyleSheet.flatten([styles.descption, { color: '#FFC92C' }])}>Careful: </Text>This features is highly advanced and may lead to a loss of access to your funds. Cypher Bank will gradually guide you through proper security measures and allow you to create vaults as you progress in your bitcoin journey.</Text>
