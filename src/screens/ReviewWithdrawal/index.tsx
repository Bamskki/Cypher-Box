...
export default function ReviewWithdrawal({ route }: Props) {
    ...
    console.log(selectedFeeName, 'selectedFeeName')
                ...
                <View style={styles.middle}>
                        ...
                        >
                            <View style={styles.background}>
                                <TouchableOpacity onPress={() => setModalVisible(true)}>
                                    <Text bold italic style={styles.vaultAddress}>
                    ...
                    {to && value && (type === 'bitcoin' || type === 'liquid') && recommendedFee ? (
                        <>
                            ...
                            <TextViewV2
                                keytext="Total Fee:  "
                                text={` ~   ${(networkFee || 0) + (bamskiiFee || 0) + (estimatedFee || 0)} sats (~0.2%)`}
                                style={styles.textContainer}
                            />
                        </>
                    ) : (
