        ...
        <ScreenLayout isBackButton={false} showToolbar title="Withdrawal Threshold">
            <View style={styles.container}>
                ...
                <View style={styles.main}>
                    <Text h4 style={styles.text}>You can adjust the threshold at which you can withdraw and materialize the money accumulated on your Checking Account.</Text>
                    ...
                    <View style={styles.extra} />
                    <Description text="Increasing the threshold will reduce the percentage fee for withdrawals but it may introduce greater counter-party risk since funds in your Checking Account are maintained by a centralized custodian. A higher threshold means your assets are under their control for an extended period, increasing the risk associated with their custody." />
                    ...
                    <View style={styles.extra} />
                    <Text h4 style={styles.text}>You should also consider setting aside a ‘Reserve Amount’  which is an amount to be left in your Checking Account after the settlement is completed. This will help you retain the ability to send and spend bitcoin cheaply using the Lightning Network.</Text>
                </View>
