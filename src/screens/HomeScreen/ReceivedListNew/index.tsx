...
import CustomTabView from "@Cypher/components/CustomTabView";
...
export default function ReceivedListNew({
  refRBSheet,
  receiveType,
  matchedRate,
  currency,
}: Props) {
  const { user, strikeMe, vaultTab } = useAuthStore();
