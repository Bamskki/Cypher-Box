...
import WalletsAddMultisigHelp, {
  WalletAddMultisigHelpNavigationOptions,
} from "./screen/wallets/addMultisigHelp";
...
import {
  ...
  LoginCoinOSScreen,
  QrScreen,
  ReceivedMethodScreen,
  SendReceiveSuccessScreen,
  SendScreen,
  SplashScreen,
  VerifyPhone,
  WelcomeScreen,
...
const WalletsRoot = () => {
  ...
  return (
    <WalletsStack.Navigator
      screenOptions={{ headerShadowVisible: false, gestureEnabled: false }}
    >
      <WalletsStack.Screen
        name="HomeScreen"
      ...
      <WalletsStack.Screen
        name="LoginBlink"
        component={LoginBlink}
        options={{ headerShown: false }}
      />
      <WalletsStack.Screen
        name="CreateCoinOSScreen"
        component={CreateCoinOSScreen}
        options={{ headerShown: false }}
      />
      <WalletsStack.Screen
        name="LoginCoinOSScreen"
        component={LoginCoinOSScreen}
        options={{ headerShown: false }}
      />
      <WalletsStack.Screen
        name="LoginBlinkPhone"
        component={LoginBlinkPhone}
        options={{ headerShown: false }}
      />
      <WalletsStack.Screen
        name="VerifyPhone"
      ...
      />
      <WalletsStack.Screen
        name="ReceivedMethodScreen"
        component={ReceivedMethodScreen}
        options={{ headerShown: false }}
      />
      <WalletsStack.Screen
        name="QrScreen"
      ...
      <WalletsStack.Screen
        name="CreatedInvoice"
        component={CreatedInvoice}
        options={{ headerShown: false }}
      />
      <WalletsStack.Screen
        name="SendReceiveSuccessScreen"
        component={SendReceiveSuccessScreen}
        options={{ headerShown: false }}
      />
      <WalletsStack.Screen
      ...
      <WalletsStack.Screen
        ...
        options={GenerateWord.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="LnurlPay"
        component={LnurlPay}
      ...
      <WalletsStack.Screen
        name="LnurlAuth"
        component={LnurlAuth}
        options={LnurlAuth.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="Success"
        component={Success}
...
const PaymentCodeStackRoot = () => {
  return (
    <PaymentCodeStack.Navigator
      name="PaymentCodeRoot"
      screenOptions={{ headerShadowVisible: false }}
      initialRouteName="PaymentCode"
    >
      <PaymentCodeStack.Screen
        name="PaymentCode"
        component={PaymentCode}
        options={{ headerTitle: loc.bip47.payment_code }}
      />
      <PaymentCodeStack.Screen
...
const NavigationFormModalOptions = {
  headerShown: false,
...
const Navigation = () => {
  return (
    <RootStack.Navigator
      ...
      screenOptions={{ headerHideShadow: true, statusBarStyle: "auto" }}
    >
      {/* stacks */}
      <RootStack.Screen
        name="WalletsRoot"
      ...
      <RootStack.Screen
        ...
        options={NavigationFormModalOptions}
      />
      <RootStack.Screen
      ...
      <RootStack.Screen
        name="PaymentCodeRoot"
        component={PaymentCodeStackRoot}
        options={NavigationDefaultOptions}
      />
    </RootStack.Navigator>
  );
