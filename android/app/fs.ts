...
const openSignedTransaction = async function (): Promise<string | boolean> {
    try {
        const res = await DocumentPicker.pickSingle({
            type: Platform.OS === 'ios' ? ['io.cypherbox.app.psbt', 'io.cypherbox.app.psbt.txn'] : [DocumentPicker.types.allFiles],
        });
    ...
    try {
        const res = await DocumentPicker.pickSingle({
            ...
            type:
                Platform.OS === 'ios'
                    ? [
                        'io.cypherbox.app.psbt',
                        'io.cypherbox.app.psbt.txn',
                        'io.cypherbox.app.backup',
